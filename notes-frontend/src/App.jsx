...
export default function App() {
    ...
    <main>
      <div className="container">
        <div className="image_container">
          <img src={`./public/Eu.jpeg`} alt="Enzo S" />
        </div>
  ...
  const Curriculo = () => (
    <div>
      ...
      <img className="img_2" src={`./public/curriculo.png`} alt="Curriculo" />
  ...
  const Projetos = () => (
    <div>
      ...
      <div className="projeto_1">
        <img className="img_3" src={`./public/TankVsTower.png`} alt="Projeto Tank Vs Towers" />
      ...
      <div className="projeto_1">
        <img className="img_3" src={`./public/InsperAsk.png`} alt="Projeto InsperAsk" />
