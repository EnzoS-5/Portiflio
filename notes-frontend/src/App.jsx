...
export default function App() {
  ...
  const Curriculo = () => (
    <div>
      ...
      <img className="img_2" src={`curriculo.png`} alt="Curriculo" />
  ...
  const Contato = () => (
    <div>
      ...
      <div className="email">
        <img src={`Gmail.jfif`} alt="Email" className="email_icon" />
        <a href="mailto:ez.santoro@gmail.com">ez.santoro@gmail.com</a>
      </div>
      <div className="linkedin">
        <img src={`LikedIN.png`} alt="LinkedIn" className="linkedin_icon" />
        <a href="https://www.linkedin.com/in/enzo-santoro-3623a4364" target="_blank" rel="noreferrer">LinkedIn</a>
      </div>
      <div className="facebook">
        <img src={`Facebook.png`} alt="Facebook" className="facebook_icon" />
