...
export default function App() {
    ...
    <main>
      <div className="container">
        <div className="image_container">
          <img src="imagens/WhatsApp Image 2025-03-17 at 13.52.56.jpeg" alt="Enzo S" />
        </div>
  ...
  const Curriculo = () => (
    <div>
      ...
      <img className="img_2" src="imagens/Captura de tela 2025-11-11 105000.png" alt="Curriculo" />
  ...
  const Projetos = () => (
    <div>
      ...
      <div className="projeto_1">
        <img className="img_3" src="imagens/ChatGPT Image 10 de abr. de 2025, 08_46_40.png" alt="Projeto 1" />
      ...
      <div className="projeto_1">
        <img className="img_3" src="imagens/Captura de tela 2025-11-11 113514.png" alt="Projeto 1" />
